...
<body>
    <?php
        ...
        $files = array('CCQEL_MU_P',
                       ...
                       'CCRES_MU_PIZERO',
                       'CCRES_MU_PIZERO_NRecoNeutrinos.png',
                       'CCRES_MU_PIZERO_VtxDeltaR.png',
                       'CCRES_MU_PIZERO_MUON_HitsEfficiency.png',
                       'CCRES_MU_PIZERO_PROTON1_HitsEfficiency.png',
                       'CCRES_MU_PIZERO_PHOTON1_HitsEfficiency.png',
                       'CCRES_MU_PIZERO_PHOTON2_HitsEfficiency.png',
                       'ALL_INTERACTIONS',
